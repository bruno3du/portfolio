    ...
    <section className="relative flex flex-col items-center justify-center h-screen overflow-hidden px-4 pt-16">
      ...
      <div className="max-w-4xl mx-auto text-center z-10">
        ...
        <div className="animate-slide-up delay-600 flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#projects"
            className="px-8 py-4 bg-foreground text-background rounded-full hover-lift hover:bg-foreground/90 transition-all"
          >
            View My Work
          </a>
          <a
            href="#contact"
            className="px-8 py-4 glass text-foreground rounded-full hover-lift transition-all"
          >
            Contact Me
          </a>
        </div>
